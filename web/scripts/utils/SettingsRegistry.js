...
const ROWS = [
    ...
    ['settingRadarKeepAwake', 'bool', true, null, 'new'],
...
const TEXTS = {
    ...
    settingRadarKeepAwake: ['Keep screen awake', 'Stops the screen from sleeping while the radar page is open. Uses more battery on phones.'],
...
const LOCATIONS = {
    ...
    'Radar > Radar settings > Display': ['settingRadarMapBackground', 'settingRadarHudZoneInfo', 'settingRadarHudStats',
        'settingRadarPlayersBeside', 'settingRadarKeepAwake'],
