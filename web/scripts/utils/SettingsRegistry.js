...
const TEXTS = {
    ...
    settingRadarResourceClusters: ['Resource clusters', 'Rings groups of nearby resource nodes of the same type and tier, with the node count, total quantity and distance. Only nodes your resource filters show are grouped.'],
    settingRadarClusterRadius: ['Cluster radius (m)', 'Resources of the same type and tier within this distance of a node are grouped. Default: 30 m.'],
    ...
    settingPlayersShowEquipment: ['Show Equipment', 'Shows the equipment the other player is carrying.'],
    settingPlayersShowSpells: ['Show Spells', 'Shows active and passive spells on player cards.'],
    ...
    settingPlayersHostile: ['Hostile', 'Lists hostile-flagged players. In black zones every player counts as hostile, so this shows or hides all of them. Does not change alerts.'],
    settingPlayersMaxDisplayed: ['Maximum Players Displayed', 'Maximum number of players to display (1-100). Default: 50'],
    settingAlertFlash: ['Screen Flash', 'Flashes the radar page red when a threat appears or turns hostile: a hostile-flagged player in yellow and red zones, any player in black zones, nobody in safe or unknown zones. Ignored names never trigger it.'],
    ...
    settingAlertSound: ['Sound Alert', 'Plays the selected sound on the PC running the radar when a threat appears or turns hostile, with the same threat rule as the flash. Ignored names never trigger it.'],
    ...
    settingEnemiesNormal: ['Normal', 'Show basic enemies (low threat, easiest to kill).'],
    settingEnemiesChampion: ['Champion', 'Champion mobs, and solo mobs in random dungeons.'],
    settingEnemiesMiniBoss: ['Mini-Boss', 'Show mini-bosses (strong enemies, valuable loot).'],
    settingEnemiesBoss: ['Boss', 'Show boss enemies (very high threat, best loot).'],
    settingEnemiesMinHealthFilter: ['Show enemies with minimum HP', 'Hides Normal to Boss enemies and unidentified enemies whose maximum HP is below the threshold. Drones, Mists bosses, event enemies and living resources are not filtered.'],
    settingEnemiesMinHealth: ['Minimum HP'],
    settingEnemiesMistsCrystalSpider: ['Crystal Spider', 'Show Crystal Spider bosses (Mists exclusive).'],
    settingEnemiesMistsFairyDragon: ['Fairy Dragon', 'Show Fairy Dragon bosses (Mists exclusive).'],
    settingEnemiesMistsVeilWeaver: ['Veil Weaver', 'Show Veil Weaver bosses (Mists exclusive).'],
    settingEnemiesMistsGriffin: ['Griffin', 'Show Griffin bosses (Mists exclusive).'],
    ...
    settingDebugEnemiesUnidentified: ['Show unidentified enemies', 'Shows enemies whose type is missing from the bundled mob data, usually new mobs after a game update. The Normal to Boss filters do not apply to them.'],
    ...
    settingChestsPurple: ['Purple', CHEST_TIP],
    settingChestsYellow: ['Yellow', CHEST_TIP],
    settingMistsSolo: ['Solo', 'Solo mist portals (1 player)'],
    settingMistsDuo: ['Duo', 'Duo mist portals (2 players)'],
    ...Object.fromEntries([0, 1, 2, 3, 4].flatMap(e => [[`settingMistsEnchant${e}`, [`E${e}`]], [`settingDungeonsEnchant${e}`, [`E${e}`]]])),
    settingMistsWispCages: ['Show Wisp Cages', 'Display wisp cages locations in mists'],
    settingMistsWisps: ['Wisp signs (pre-portal)', 'Shows the wisp signs that appear before a Mists portal opens. The Solo/Duo and rarity filters also apply.'],
    settingMistsKnightfallAbbey: ['Show Knightfall Abbey', 'Shows Knightfall Abbey entrances.'],
    settingDebugMistsWispIds: ['Show wisp ID (debug)'],
    settingDungeonsSolo: ['Solo', 'Solo random dungeons'],
