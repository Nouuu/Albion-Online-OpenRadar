...
const ROWS = [
    ...
    ['settingUiPlayersTypesOpen', 'bool', true, null, 'new'],
    ['settingUiPlayersLimitsOpen', 'bool', true, null, 'new'],
    ['settingUiChestsRaritiesOpen', 'bool', true, null, 'new'],
    ['settingUiChestsMistsOpen', 'bool', true, null, 'new'],
    ['settingUiChestsDungeonsOpen', 'bool', true, null, 'new'],
    ['settingUiIgnoreListAddNameOpen', 'bool', true, null, 'new'],
    ['settingUiIgnoreListIgnoredNamesOpen', 'bool', true, null, 'new'],
...
const TEXTS = {
    ...
    settingUiPlayersTypesOpen: ['Player Types'],
    settingUiPlayersLimitsOpen: ['Limits'],
    settingUiChestsRaritiesOpen: ['Chests'],
    settingUiChestsMistsOpen: ['Mists'],
    settingUiChestsDungeonsOpen: ['Dungeons'],
    settingUiIgnoreListAddNameOpen: ['Add name'],
    settingUiIgnoreListIgnoredNamesOpen: ['Ignored names'],
...
const LOCATIONS = {
    ...
    'Ignore List > Add name': ['settingUiIgnoreListAddNameOpen'],
    'Ignore List > Ignored names': ['settingUiIgnoreListIgnoredNamesOpen'],
