...
const TEXTS = {
    ...
    settingRadarFitToScreen: ['Fit to screen', 'Largest square that fits the window, up to 1200 px, next to the player list when it sits beside. Overrides Max size.'],
    ...
    settingAlertSound: ['Sound Alert', 'Plays the alert sound, same trigger rule as Screen Flash. Ignored names never trigger it.'],
    ...
    settingEnemiesMinHealthFilter: ['Show enemies with minimum HP', 'Hides low-HP Normal-Boss enemies. Drones, Mists bosses, events, living resources exempt.'],
    ...
    settingLogToServer: ['Save browser logs', 'Saves filtered entries to logs/debug/. Errors are also copied to logs/errors/.'],
