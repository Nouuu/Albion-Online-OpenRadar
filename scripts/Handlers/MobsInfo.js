class MobsInfo{
    ...
    initMobs()
    {
        //#region Living Resources - FUSIONNÃ‰ (235 TypeID)
        // Source: MobsInfo.js original + MobsInfo_Enriched.js (corrections terrain)
        // GÃ©nÃ©rÃ© automatiquement le 2025-11-01T19:34:45.532Z
        ...
        this.addItem(528, 3, 0, "Fiber"); // ?? CORRIGÉ: était Rock T4, en réalité Fiber T3
